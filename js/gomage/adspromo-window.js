...
Window.prototype = {
  ...
  _createWindow: function(id) {
    ...
    win.className = "gomage_aap_dialog";
    ...
    win.innerHTML = closeDiv + minDiv + maxDiv + "\
      ...
      <table id='"+ id +"_row1' class=\"gomage_aap_top gomage_aap_table_window\">\
        <tr>\
      ...
      <table id='"+ id +"_row2' class=\"gomage_aap_mid gomage_aap_table_window\">\
        <tr>\
        ...
        <table id='"+ id +"_row3' class=\"gomage_aap_bot gomage_aap_table_window\">\
        <tr>\
